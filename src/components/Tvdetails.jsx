...
import { asyncloadtv } from '../store/reducers/actions/tvActions'
...
function Tvdetails() {
  ...
  return info ? (
    <div
      ...
      className='relative w-screen h-[240vh] px-[10%] overflow-x-hidden'>
      ...
      <div className='w-full flex mt-5'>
        ...
        <div className='content ml-[5%] text-white'>
          ...
          <Link className='p-4 bg-[#6556CD] rounded-lg'
            to={`${pathname}/trailer`}
            >
